...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Universal Career Navigator" },
      {
        name: "description",
        content:
          "Career guidance for every field: assessment, student profile, career matches, course, city, exam, colleges, roadmap and progress.",
      },
      { name: "author", content: "Team PathPilot" },
